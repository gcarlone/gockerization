...
func GetItems(items *[]Item) (err error) {
	if err := DB.Find(items).Error; err != nil {
		log.Fatal("Problem find item: " + err.Error())
		return err
	}
	return nil
}
...
func CreateItem(item *Item) error {
	if err := DB.Create(item).Error; err != nil {
		log.Fatal("Problem create item: " + err.Error())
		return err
	}
...
func GetItem(item *Item, itemId string) error {
	if err := DB.Where("id = ?", itemId).First(item).Error; err != nil {
		log.Fatal("Problem get item: " + err.Error())
		return err
	}
	return nil
}
...
func DeleteItem(item *Item) error {
	if err := DB.Delete(item).Error; err != nil {
		log.Fatal("Problem delete item: " + err.Error())
		return err
	}
